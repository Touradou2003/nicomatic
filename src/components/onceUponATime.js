...
export default function OnceUponATime()
{
    return(
        ...
        <div class="sourire">
            <img src={sourire} alt="sourire" id="sourire"/>
            </div>
        <div class="text">

        <h1 class="titre">Il était une fois</h1>
        <p>lorem lorem ipsumWe love that you love Bito’s AI Code Completions!
...
To receive more Completions, please upgrade your plan or contact mailto:support@bito.aiWe love that you love Bito’s AI Code Completions!
You have hit your limit for AI Code Completions per day on your plan.
To receive more Completions, please upgrade your plan or contact mailto:support@bito.aiWe love that you love Bito’s AI Code Completions!</p>
</div>
